...
namespace blqw.Convertors
{
    ...
    {
        public ConvertResult<byte[]> From(ConvertContext context, string input) => input == null ? null : input.Length == 0 ? Array.Empty<byte>() : context.GetEncoding().GetBytes(input);
        ...
        public ConvertResult<byte[]> From(ConvertContext context, DateTime input) => context.InvalidCastException(input, TypeFriendlyName);
