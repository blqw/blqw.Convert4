...
namespace blqw.Kanai.Dynamic
{
    ...
    public class DynamicEntity : DynamicObject, IObjectReference//, IObjectHandle, ICustomTypeProvider
    {
        ...
        public DynamicEntity(object entity, ConvertSettings settings) : this(entity) => _settings = settings;
        ...
        {
            var r = Cube.Convert(_entity, binder.ReturnType, _settings);
            if (r.Success)
            {
        ...
        public override bool TryGetMember(GetMemberBinder binder, out object result)
        {
            ...
            if (p?.Get != null)
            {
                ...
                var r = result.Convert(binder.ReturnType, _settings);
                result = r.Success ? DynamicFactory.Create(r.OutputValue, _settings) : DynamicPrimitive.Null;
                return true;
            }
        ...
        public override bool TrySetMember(SetMemberBinder binder, object value)
        {
            ...
            var ex = p.SetValue(_settings, _entity, value);
            if (ex != null)
            {
                throw ex;
            }
